...
export class PreferencesService {
  ...
  //Added CS Name
  set csName(value: string) {
    this.prefs.csName = value;
    this.savePrefs();
  }
  get csName(): string {
    return this.prefs.csName;
  }
...
export const DEP_PA: string = "Good [MORNING] ladies and gentlemen.\n\n" +
  ...
  "I would like to welcome you on board this [ACTYPE], flight [NUMBER] to [DESTINATION], [DESTINATION_NAME].\n\n" +
  "Beside me here on the Flight Deck is [FDCREW]. And looking after your " +
  "safety and comfort in the cabin today are CSD [CSDNAME] / CS [CSNAME] , and our award - winning team.\n\n" +
